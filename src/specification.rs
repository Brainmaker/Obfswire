...
#[allow(unused)] pub(crate) const INIT_FRAME_MIN_LEN: usize = INIT_HDR_LEN + INIT_BODY_MIN_LEN;
...
#[allow(unused)] pub(crate) const INIT_PAD_MAX_LEN: usize = INIT_PAYLOAD_MAX_LEN;
#[allow(unused)] pub(crate) const INIT_PAD_MIN_LEN: usize = INIT_PAYLOAD_MIN_LEN;
...
#[allow(unused)] pub(crate) const PADDING_MAX_LEN: usize = PAYLOAD_MAX_LEN;
#[allow(unused)] pub(crate) const PADDING_MIN_LEN: usize = PAYLOAD_MIN_LEN;
